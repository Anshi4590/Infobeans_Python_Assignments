...
def secondhighest():
    ...
    print(f"The Second Highest Age is : {second}")
...
def senioremployee():
    ...
    print(f"Count of Senior Employees : {count}")

def removeduplicate():

    unique = list(set(age))

    print(f"Unique Ages : {unique}")
...
def withvowels():
    ...
    print(f" Count of Names Starting with vowels : {count}")
...
def longest():
    ...
    print(f"Longest Employee Name :{max_name}")


age = list(map(int,input("Enter Age : ").split()))
names = list(input("Enter Name  : ").split())
...
while True:
    ...
    match choice :
        ...
        case 1:
            print("Finding the Second Highest element in the Employee age : ")
