...
class ExpenseTracker:
    ...
    def calculate_total_expenses(self):
        ...
        total = self.rent + self.food_expenses + self.travel_expenses +  self.other_expenses
        return total

    def calculate_savings(self):

        save =  self.monthly_salary - self.calculate_total_expenses()
        return save
...
# Object creation
expense = ExpenseTracker("Amit", 60000, 12000, 8000, 5000, 3000)
